...
这段时间读书攒下了不少思维模型——芒格的多元思维、卡尼曼的系统 1/2、西奥迪尼的影响力……但真到生活、工作、关系里的具体决策时刻，它们基本派不上用场：大脑记忆有限，最先接管的永远是系统一的直觉和认知偏差。所以把思维模型外置：把 10 位人物各自的思维模型、代表语录、自觉盲区写成结构化人设（其中芒格、卡尼曼、西奥迪尼正是那些书的作者本人），让他们在一张圆桌上就你的问题当面交锋、互相反驳，最后每人给出一张带立场的决策卡——你拿到的不是"标准答案"，是被 10 套思维模型各拆了一遍的问题。
